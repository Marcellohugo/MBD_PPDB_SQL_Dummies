...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 16 Mar 2025 pada 09.46
...
(1, 1, 'Pending', '2025-05-01'),
(2, 2, 'Pending', '2025-05-02'),
(3, 3, 'Rejected', '2025-05-03'),
(4, 4, 'Pending', '2025-05-04'),
(5, 5, 'Approved', '2025-05-05'),
(6, 6, 'Rejected', '2025-05-06'),
(7, 7, 'Approved', '2025-05-07'),
(8, 8, 'Pending', '2025-05-08'),
(9, 9, 'Rejected', '2025-05-09'),
(10, 10, 'Pending', '2025-05-10'),
(11, 11, 'Approved', '2025-05-11'),
(12, 12, 'Rejected', '2025-05-12'),
(13, 13, 'Pending', '2025-05-13'),
(14, 14, 'Approved', '2025-05-14'),
(15, 15, 'Rejected', '2025-05-15'),
(16, 16, 'Pending', '2025-05-16'),
(17, 17, 'Approved', '2025-05-17'),
(18, 18, 'Approved', '2025-05-18'),
(19, 19, 'Pending', '2025-05-19'),
(20, 20, 'Pending', '2025-05-20'),
(21, 21, 'Rejected', '2025-05-21'),
(22, 22, 'Pending', '2025-05-22'),
(23, 23, 'Pending', '2025-05-23'),
(24, 24, 'Rejected', '2025-05-24'),
(25, 25, 'Pending', '2025-05-25'),
(26, 26, 'Approved', '2025-05-26'),
(27, 27, 'Approved', '2025-05-27'),
(28, 28, 'Rejected', '2025-05-28'),
(29, 29, 'Rejected', '2025-05-29'),
(30, 30, 'Rejected', '2025-05-30'),
(31, 31, 'Pending', '2025-06-01'),
(32, 32, 'Approved', '2025-06-02'),
(33, 33, 'Approved', '2025-06-03'),
(34, 34, 'Pending', '2025-06-04'),
(35, 35, 'Approved', '2025-06-05'),
(36, 36, 'Approved', '2025-06-06'),
(37, 37, 'Pending', '2025-06-07'),
(38, 38, 'Approved', '2025-06-08'),
(39, 39, 'Approved', '2025-06-09'),
(40, 40, 'Pending', '2025-06-10'),
(41, 41, 'Rejected', '2025-06-11'),
(42, 42, 'Rejected', '2025-06-12'),
(43, 43, 'Pending', '2025-06-13'),
(44, 44, 'Approved', '2025-06-14'),
(45, 45, 'Approved', '2025-06-15'),
(46, 46, 'Pending', '2025-06-16'),
(47, 47, 'Approved', '2025-06-17'),
(48, 48, 'Approved', '2025-06-18'),
(49, 49, 'Pending', '2025-06-19'),
(50, 50, '', '2025-06-20');
...
(5, 'Perpindahan Orang Tua'),
(6, 'Anak Guru'),
(7, 'Difabel'),
(8, 'KIP-Kuliah'),
(9, 'Sekolah Mitra'),
(10, 'Anak TNI/Polri'),
(11, 'Beasiswa Pendidikan'),
(12, 'Jalur Mandiri'),
(13, 'Undangan Khusus'),
(14, 'Program Akselerasi'),
(15, 'Program Reguler'),
(16, 'Program Internasional'),
(17, 'Anak Berprestasi Nasional'),
(18, 'Anak Berprestasi Internasional'),
(19, 'Lintas Provinsi'),
(20, 'Rekomendasi Sekolah'),
(21, 'Jalur Olahraga'),
(22, 'Jalur Seni'),
(23, 'Program Kerjasama'),
(24, 'Jalur Pesantren'),
(25, 'Jalur Anak Yatim'),
(26, 'Jalur Anak Berkebutuhan Khusus'),
(27, 'Jalur Anak Panti Asuhan'),
(28, 'Jalur Anak Veteran'),
(29, 'Jalur Anak Pegawai Negeri'),
(30, 'Jalur Anak Buruh'),
(31, 'Jalur Prestasi Olahraga'),
(32, 'Jalur Prestasi Seni'),
(33, 'Jalur Beasiswa Prestasi'),
(34, 'Jalur Beasiswa Sosial'),
(35, 'Jalur Anak Nelayan'),
(36, 'Jalur Anak Petani'),
(37, 'Jalur Program Pemerintah'),
(38, 'Jalur Program Khusus Daerah'),
(39, 'Jalur Siswa Berprestasi'),
(40, 'Jalur Program Afirmasi Daerah'),
(41, 'Jalur Sekolah Berasrama'),
(42, 'Jalur Program Pendidikan Vokasi'),
(43, 'Jalur Siswa Berbakat'),
(44, 'Jalur Akademik Khusus'),
(45, 'Jalur Prioritas Pemerintah'),
(46, 'Jalur Program Inklusi'),
(47, 'Jalur Pemulihan Ekonomi'),
(48, 'Jalur Bina Lingkungan'),
(49, 'Jalur Kelas Khusus'),
(50, 'Jalur Siswa Berbakat Teknologi');
...
INSERT INTO `pendaftaran` (`Id_pendaftaran`, `Id_peserta`, `Id_sekolah`, `Id_jalur`, `Tanggal_pendaftaran`) VALUES
(1, 1, 1, 1, '2025-03-01'),
(2, 2, 2, 2, '2025-03-02'),
(3, 3, 3, 3, '2025-03-03'),
(4, 4, 4, 4, '2025-03-04'),
...
(8, 8, 3, 8, '2025-03-08'),
(9, 9, 4, 9, '2025-03-09'),
(10, 10, 5, 10, '2025-03-10'),
(11, 11, 1, 11, '2025-03-11'),
(12, 12, 2, 12, '2025-03-12'),
(13, 13, 3, 13, '2025-03-13'),
(14, 14, 4, 14, '2025-03-14'),
(15, 15, 5, 15, '2025-03-15'),
(16, 16, 1, 16, '2025-03-16'),
(17, 17, 2, 17, '2025-03-17'),
(18, 18, 3, 18, '2025-03-18'),
(19, 19, 4, 19, '2025-03-19'),
(20, 20, 5, 20, '2025-03-20'),
(21, 21, 1, 21, '2025-03-21'),
(22, 22, 2, 22, '2025-03-22'),
(23, 23, 3, 23, '2025-03-23'),
(24, 24, 4, 24, '2025-03-24'),
(25, 25, 5, 25, '2025-03-25'),
(26, 26, 1, 26, '2025-03-26'),
(27, 27, 2, 27, '2025-03-27'),
(28, 28, 3, 28, '2025-03-28'),
(29, 29, 4, 29, '2025-03-29'),
(30, 30, 5, 30, '2025-03-30'),
(31, 31, 1, 31, '2025-03-31'),
(32, 32, 2, 32, '2025-04-01'),
(33, 33, 3, 33, '2025-04-02'),
(34, 34, 4, 34, '2025-04-03'),
(35, 35, 5, 35, '2025-04-04'),
(36, 36, 1, 36, '2025-04-05'),
(37, 37, 2, 37, '2025-04-06'),
(38, 38, 3, 38, '2025-04-07'),
(39, 39, 4, 39, '2025-04-08'),
(40, 40, 5, 40, '2025-04-09'),
(41, 41, 1, 41, '2025-04-10'),
(42, 42, 2, 42, '2025-04-11'),
(43, 43, 3, 43, '2025-04-12'),
(44, 44, 4, 44, '2025-04-13'),
(45, 45, 5, 45, '2025-04-14'),
(46, 46, 1, 46, '2025-04-15'),
(47, 47, 2, 47, '2025-04-16'),
(48, 48, 3, 48, '2025-04-17'),
(49, 49, 4, 49, '2025-04-18'),
(50, 50, 5, 50, '2025-04-19');
...
CREATE TABLE `pengumuman` (
  `Id_pengumuman` int(11) NOT NULL,
  `Id_pendaftaran` int(11) NOT NULL,
  `Status_kelulusan` enum('Approved','Rejected') NOT NULL,
